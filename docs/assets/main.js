...
var Alert = function (jQuery) {
  ...
  var Alert = function () {
    ...
    Alert.prototype._removeElement = function _removeElement(element) {
      ...
      if (!Util.supportsTransitionEnd() || !jQuery(element).hasClass(ClassName.FADE)) {
...
var Button = function (jQuery) {
  ...
  var Button = function () {
    ...
    Button.prototype.toggle = function toggle() {
      ...
      var rootElement = jQuery(this._element).closest(Selector.DATA_TOGGLE)[0];

      if (rootElement) {
        var input = jQuery(this._element).find(Selector.INPUT)[0];

        if (input) {
          if (input.type === 'radio') {
            if (input.checked && jQuery(this._element).hasClass(ClassName.ACTIVE)) {
              triggerChangeEvent = false;
            } else {
              var activeElement = jQuery(rootElement).find(Selector.ACTIVE)[0];
          ...
          if (triggerChangeEvent) {
            input.checked = !jQuery(this._element).hasClass(ClassName.ACTIVE);
      ...
      this._element.setAttribute('aria-pressed', !jQuery(this._element).hasClass(ClassName.ACTIVE));
  ...
  jQuery(document).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE_CARROT, function (event) {
    event.preventDefault();
    ...
    var button = jQuery(event.target).closest(Selector.BUTTON)[0];
    jQuery(button).toggleClass(ClassName.FOCUS, /^focus(in)?jQuery/.test(event.type));
  });
...
var Carousel = function (jQuery) {
  ...
  var Carousel = function () {
    function Carousel(element, config) {
      ...
      this._element = jQuery(element)[0];
      this._indicatorsElement = jQuery(this._element).find(Selector.INDICATORS)[0];
    ...
    Carousel.prototype.pause = function pause(event) {
      ...
      if (jQuery(this._element).find(Selector.NEXT_PREV)[0] && Util.supportsTransitionEnd()) {
    ...
    Carousel.prototype.to = function to(index) {
      ...
      this._activeElement = jQuery(this._element).find(Selector.ACTIVE_ITEM)[0];
      ...
      if (this._isSliding) {
        jQuery(this._element).one(Event.SLID, function () {
    ...
    Carousel.prototype.dispose = function dispose() {
      jQuery(this._element).off(EVENT_KEY);
      jQuery.removeData(this._element, DATA_KEY);
    ...
    Carousel.prototype._addEventListeners = function _addEventListeners() {
      ...
      if (this._config.keyboard) {
        jQuery(this._element).on(Event.KEYDOWN, function (event) {
          return _this4._keydown(event);
        });
      }

      if (this._config.pause === 'hover' && !('ontouchstart' in document.documentElement)) {
        jQuery(this._element).on(Event.MOUSEENTER, function (event) {
    ...
    Carousel.prototype._getItemIndex = function _getItemIndex(element) {
      this._items = jQuery.makeArray(jQuery(element).parent().find(Selector.ITEM));
    ...
    Carousel.prototype._triggerSlideEvent = function _triggerSlideEvent(relatedTarget, eventDirectionName) {
      var slideEvent = jQuery.Event(Event.SLIDE, {
    ...
    Carousel.prototype._setActiveIndicatorElement = function _setActiveIndicatorElement(element) {
      if (this._indicatorsElement) {
        jQuery(this._indicatorsElement).find(Selector.ACTIVE).removeClass(ClassName.ACTIVE);

        var nextIndicator = this._indicatorsElement.children[this._getItemIndex(element)];

        if (nextIndicator) {
          jQuery(nextIndicator).addClass(ClassName.ACTIVE);
        }
      }
    };
    ...
    Carousel.prototype._slide = function _slide(direction, element) {
      ...
      var activeElement = jQuery(this._element).find(Selector.ACTIVE_ITEM)[0];
      ...
      if (nextElement && jQuery(nextElement).hasClass(ClassName.ACTIVE)) {
        this._isSliding = false;
        return;
      }
      ...
      var slidEvent = jQuery.Event(Event.SLID, {
        relatedTarget: nextElement,
        direction: eventDirectionName
      });

      if (Util.supportsTransitionEnd() && jQuery(this._element).hasClass(ClassName.SLIDE)) {
        ...
        jQuery(activeElement).one(Util.TRANSITION_END, function () {
          jQuery(nextElement).removeClass(directionalClassName + ' ' + orderClassName).addClass(ClassName.ACTIVE);

          jQuery(activeElement).removeClass(ClassName.ACTIVE + ' ' + orderClassName + ' ' + directionalClassName);

          _this5._isSliding = false;

          setTimeout(function () {
            return jQuery(_this5._element).trigger(slidEvent);
          }, 0);
        }).emulateTransitionEnd(TRANSITION_DURATION);
      } else {
        jQuery(activeElement).removeClass(ClassName.ACTIVE);
        jQuery(nextElement).addClass(ClassName.ACTIVE);
    ...
    Carousel._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        var data = jQuery(this).data(DATA_KEY);
        var _config = jQuery.extend({}, Default, jQuery(this).data());
    ...
    Carousel._dataApiClickHandler = function _dataApiClickHandler(event) {
      ...
      if (!target || !jQuery(target).hasClass(ClassName.CAROUSEL)) {
        return;
      }

      var config = jQuery.extend({}, jQuery(target).data(), jQuery(this).data());
      ...
      if (slideIndex) {
        jQuery(target).data(DATA_KEY).to(slideIndex);
      }
  ...
  jQuery(document).on(Event.CLICK_DATA_API, Selector.DATA_SLIDE, Carousel._dataApiClickHandler);

  jQuery(window).on(Event.LOAD_DATA_API, function () {
    jQuery(Selector.DATA_RIDE).each(function () {
...
var Collapse = function (jQuery) {
  ...
  var Collapse = function () {
    function Collapse(element, config) {
      ...
      this._element = element;
      this._config = this._getConfig(config);
      this._triggerArray = jQuery.makeArray(jQuery('[data-toggle="collapse"][href="#' + element.id + '"],' + ('[data-toggle="collapse"][data-target="#' + element.id + '"]')));
    ...
    Collapse.prototype.show = function show() {
      ...
      if (this._parent) {
        actives = jQuery.makeArray(jQuery(this._parent).find(Selector.ACTIVES));
        if (!actives.length) {
          actives = null;
        }
      }
      ...
      if (actives) {
        activesData = jQuery(actives).data(DATA_KEY);
      ...
      if (actives) {
        Collapse._jQueryInterface.call(jQuery(actives), 'hide');
        if (!activesData) {
      ...
      jQuery(this._element).removeClass(ClassName.COLLAPSE).addClass(ClassName.COLLAPSING);

      this._element.style[dimension] = 0;
      this._element.setAttribute('aria-expanded', true);

      if (this._triggerArray.length) {
        jQuery(this._triggerArray).removeClass(ClassName.COLLAPSED).attr('aria-expanded', true);
      }

      this.setTransitioning(true);

      var complete = function complete() {
        jQuery(_this6._element).removeClass(ClassName.COLLAPSING).addClass(ClassName.COLLAPSE).addClass(ClassName.SHOW);

        _this6._element.style[dimension] = '';

        _this6.setTransitioning(false);

        jQuery(_this6._element).trigger(Event.SHOWN);
      };
      ...
      jQuery(this._element).one(Util.TRANSITION_END, complete).emulateTransitionEnd(TRANSITION_DURATION);
    ...
    Collapse.prototype.hide = function hide() {
      ...
      jQuery(this._element).addClass(ClassName.COLLAPSING).removeClass(ClassName.COLLAPSE).removeClass(ClassName.SHOW);

      this._element.setAttribute('aria-expanded', false);

      if (this._triggerArray.length) {
        jQuery(this._triggerArray).addClass(ClassName.COLLAPSED).attr('aria-expanded', false);
      }
      ...
      var complete = function complete() {
        ...
        jQuery(_this7._element).removeClass(ClassName.COLLAPSING).addClass(ClassName.COLLAPSE).trigger(Event.HIDDEN);
      };
    ...
    Collapse.prototype._getParent = function _getParent() {
      ...
      var parent = jQuery(this._config.parent)[0];
      var selector = '[data-toggle="collapse"][data-parent="' + this._config.parent + '"]';

      jQuery(parent).find(selector).each(function (i, element) {
    ...
    Collapse.prototype._addAriaAndCollapsedClass = function _addAriaAndCollapsedClass(element, triggerArray) {
      if (element) {
        ...
        if (triggerArray.length) {
          jQuery(triggerArray).toggleClass(ClassName.COLLAPSED, !isOpen).attr('aria-expanded', isOpen);
        }
      }
    };
    ...
    Collapse._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        ...
        var data = jQuerythis.data(DATA_KEY);
        var _config = jQuery.extend({}, Default, jQuerythis.data(), (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' && config);
  ...
  jQuery(document).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, function (event) {
    ...
    var data = jQuery(target).data(DATA_KEY);
    var config = data ? 'toggle' : jQuery(this).data();
...
var Dropdown = function (jQuery) {
  ...
  var Dropdown = function () {
    ...
    Dropdown.prototype.toggle = function toggle() {
      ...
      if ('ontouchstart' in document.documentElement && !jQuery(parent).closest(Selector.NAVBAR_NAV).length) {
        ...
        jQuery(dropdown).insertBefore(this);
        jQuery(dropdown).on('click', Dropdown._clearMenus);
      }
      ...
      jQuery(parent).toggleClass(ClassName.SHOW);
      jQuery(parent).trigger(jQuery.Event(Event.SHOWN, relatedTarget));
    ...
    Dropdown._clearMenus = function _clearMenus(event) {
      ...
      var toggles = jQuery.makeArray(jQuery(Selector.DATA_TOGGLE));
      ...
      for (var i = 0; i < toggles.length; i++) {
        ...
        if (event && (event.type === 'click' && /input|textarea/i.test(event.target.tagName) || event.type === 'focusin') && jQuery.contains(parent, event.target)) {
          continue;
        }
  ...
  jQuery(document).on(Event.KEYDOWN_DATA_API, Selector.DATA_TOGGLE, Dropdown._dataApiKeydownHandler).on(Event.KEYDOWN_DATA_API, Selector.ROLE_MENU, Dropdown._dataApiKeydownHandler).on(Event.KEYDOWN_DATA_API, Selector.ROLE_LISTBOX, Dropdown._dataApiKeydownHandler).on(Event.CLICK_DATA_API + ' ' + Event.FOCUSIN_DATA_API, Dropdown._clearMenus).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, Dropdown.prototype.toggle).on(Event.CLICK_DATA_API, Selector.FORM_CHILD, function (e) {
    e.stopPropagation();
  });
  ...
  var Modal = function () {
    ...
    Modal.prototype.show = function show(relatedTarget) {
      ...
      jQuery(this._dialog).on(Event.MOUSEDOWN_DISMISS, function () {
        jQuery(_this9._element).one(Event.MOUSEUP_DISMISS, function (event) {
          if (jQuery(event.target).is(_this9._element)) {
    ...
    Modal.prototype._showElement = function _showElement(relatedTarget) {
      ...
      var transitionComplete = function transitionComplete() {
        ...
        jQuery(_this11._element).trigger(shownEvent);
      };
    ...
    Modal.prototype._enforceFocus = function _enforceFocus() {
      ...
      .on(Event.FOCUSIN, function (event) {
        if (document !== event.target && _this12._element !== event.target && !jQuery(_this12._element).has(event.target).length) {
    ...
    Modal.prototype._hideModal = function _hideModal() {
      ...
      this._showBackdrop(function () {
        ...
        jQuery(_this15._element).trigger(Event.HIDDEN);
      });
    };
    ...
    Modal._jQueryInterface = function _jQueryInterface(config, relatedTarget) {
      return this.each(function () {
        var data = jQuery(this).data(DATA_KEY);
        var _config = jQuery.extend({}, Modal.Default, jQuery(this).data(), (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' && config);
...
var ScrollSpy = function (jQuery) {
  ...
  var ScrollSpy = function () {
    function ScrollSpy(element, config) {
      ...
      jQuery(this._scrollElement).on(Event.SCROLL, function (event) {
    ...
    ScrollSpy.prototype.refresh = function refresh() {
      ...
      var targets = jQuery.makeArray(jQuery(this._selector));
      ...
      targets.map(function (element) {
        ...
        if (targetSelector) {
          target = jQuery(targetSelector)[0];
        }
    ...
    ScrollSpy.prototype.dispose = function dispose() {
      jQuery.removeData(this._element, DATA_KEY);
      jQuery(this._scrollElement).off(EVENT_KEY);
    ...
    ScrollSpy.prototype._activate = function _activate(target) {
      ...
      var jQuerylink = jQuery(queries.join(','));

      if (jQuerylink.hasClass(ClassName.DROPDOWN_ITEM)) {
        jQuerylink.closest(Selector.DROPDOWN).find(Selector.DROPDOWN_TOGGLE).addClass(ClassName.ACTIVE);
        jQuerylink.addClass(ClassName.ACTIVE);
      } else {
        // todo (fat) this is kinda sus...
        // recursively add actives to tested nav-links
        jQuerylink.parents(Selector.LI).find('> ' + Selector.NAV_LINKS).addClass(ClassName.ACTIVE);
      }

      jQuery(this._scrollElement).trigger(Event.ACTIVATE, {
        relatedTarget: target
      });
    };

    ScrollSpy.prototype._clear = function _clear() {
      jQuery(this._selector).filter(Selector.ACTIVE).removeClass(ClassName.ACTIVE);
    };
  ...
  jQuery(window).on(Event.LOAD_DATA_API, function () {
    var scrollSpys = jQuery.makeArray(jQuery(Selector.DATA_SPY));
...
var Tab = function (jQuery) {
  ...
  var Tab = function () {
    ...
    Tab.prototype.show = function show() {
      ...
      var target = void 0;
      var previous = void 0;
      var listElement = jQuery(this._element).closest(Selector.LIST)[0];
      var selector = Util.getSelectorFromElement(this._element);

      if (listElement) {
        previous = jQuery.makeArray(jQuery(listElement).find(Selector.ACTIVE));
      ...
      var complete = function complete() {
        ...
        jQuery(_this20._element).trigger(shownEvent);
      };
    ...
    Tab.prototype.dispose = function dispose() {
      jQuery.removeClass(this._element, DATA_KEY);
      this._element = null;
    };
    ...
    Tab.prototype._activate = function _activate(element, container, callback) {
      ...
      var active = jQuery(container).find(Selector.ACTIVE_CHILD)[0];
      var isTransitioning = callback && Util.supportsTransitionEnd() && (active && jQuery(active).hasClass(ClassName.FADE) || Boolean(jQuery(container).find(Selector.FADE_CHILD)[0]));
      ...
      if (active && isTransitioning) {
        jQuery(active).one(Util.TRANSITION_END, complete).emulateTransitionEnd(TRANSITION_DURATION);
      } else {
        complete();
      }

      if (active) {
        jQuery(active).removeClass(ClassName.SHOW);
      }
    };
    ...
    Tab.prototype._transitionComplete = function _transitionComplete(element, active, isTransitioning, callback) {
      ...
      if (isTransitioning) {
        ...
        jQuery(element).removeClass(ClassName.FADE);
      }
      ...
      if (element.parentNode && jQuery(element.parentNode).hasClass(ClassName.DROPDOWN_MENU)) {
        ...
        if (dropdownElement) {
          jQuery(dropdownElement).find(Selector.DROPDOWN_TOGGLE).addClass(ClassName.ACTIVE);
        }
  ...
  var Tooltip = function () {
    ...
    Tooltip.prototype.toggle = function toggle(event) {
      if (event) {
        ...
        if (jQuery(this.getTipElement()).hasClass(ClassName.SHOW)) {
    ...
    Tooltip.prototype.dispose = function dispose() {
      ...
      jQuery(this.element).closest('.modal').off('hide.bs.modal');
    ...
    Tooltip.prototype.show = function show() {
      ...
      if (this.isWithContent() && this._isEnabled) {
        ...
        var isInTheDom = jQuery.contains(this.element.ownerDocument.documentElement, this.element);
        ...
        if (this.config.animation) {
          jQuery(tip).addClass(ClassName.FADE);
        }
        ...
        var container = this.config.container === false ? document.body : jQuery(this.config.container);

        jQuery(tip).data(this.constructor.DATA_KEY, this).appendTo(container);
        ...
        jQuery(tip).addClass(ClassName.SHOW);
        ...
        var complete = function complete() {
          ...
          jQuery(_this22.element).trigger(_this22.constructor.Event.SHOWN);
        ...
        if (Util.supportsTransitionEnd() && jQuery(this.tip).hasClass(ClassName.FADE)) {
          this._isTransitioning = true;
          jQuery(this.tip).one(Util.TRANSITION_END, complete).emulateTransitionEnd(Tooltip._TRANSITION_DURATION);
          return;
        }
    ...
    Tooltip.prototype.hide = function hide(callback) {
      ...
      var complete = function complete() {
        ...
        jQuery(_this23.element).trigger(_this23.constructor.Event.HIDDEN);
      ...
      jQuery(tip).removeClass(ClassName.SHOW);
      ...
      if (Util.supportsTransitionEnd() && jQuery(this.tip).hasClass(ClassName.FADE)) {
        this._isTransitioning = true;
        jQuery(tip).one(Util.TRANSITION_END, complete).emulateTransitionEnd(TRANSITION_DURATION);
      } else {
        complete();
      }
    ...
    Tooltip.prototype.getTipElement = function getTipElement() {
      return this.tip = this.tip || jQuery(this.config.template)[0];
    };

    Tooltip.prototype.setContent = function setContent() {
      var jQuerytip = jQuery(this.getTipElement());

      this.setElementContent(jQuerytip.find(Selector.TOOLTIP_INNER), this.getTitle());

      jQuerytip.removeClass(ClassName.FADE + ' ' + ClassName.SHOW);

      this.cleanupTether();
    };

    Tooltip.prototype.setElementContent = function setElementContent(jQueryelement, content) {
      ...
      if ((typeof content === 'undefined' ? 'undefined' : _typeof(content)) === 'object' && (content.nodeType || content.jquery)) {
        ...
        jQueryelement[html ? 'html' : 'text'](content);
      }
    };
    ...
    Tooltip.prototype._setListeners = function _setListeners() {
      ...
      triggers.forEach(function (trigger) {
        if (trigger === 'click') {
          jQuery(_this24.element).on(_this24.constructor.Event.CLICK, _this24.config.selector, function (event) {
          ...
          jQuery(_this24.element).on(eventIn, _this24.config.selector, function (event) {
        ...
        jQuery(_this24.element).closest('.modal').on('hide.bs.modal', function () {
          return _this24.hide();
        });
      });

      if (this.config.selector) {
        this.config = jQuery.extend({}, this.config, {
          trigger: 'manual',
          selector: ''
        });
      } else {
    ...
    Tooltip.prototype._enter = function _enter(event, context) {
      ...
      if (jQuery(context.getTipElement()).hasClass(ClassName.SHOW) || context._hoverState === HoverState.SHOW) {
    ...
    Tooltip.prototype._getConfig = function _getConfig(config) {
      config = jQuery.extend({}, this.constructor.Default, jQuery(this.element).data(), config);
...
var Popover = function (jQuery) {
  ...
  var Default = jQuery.extend({}, Tooltip.Default, {
    placement: 'right',
    trigger: 'click',
    content: '',
  ...
  var DefaultType = jQuery.extend({}, Tooltip.DefaultType, {
  ...
  var Popover = function (_Tooltip) {
    ...
    Popover.prototype.setContent = function setContent() {
      ...
      this.setElementContent(jQuerytip.find(Selector.TITLE), this.getTitle());
      this.setElementContent(jQuerytip.find(Selector.CONTENT), this._getContent());
...
},{"./blockoldbrowsers":4,"./bootstrap":5,"./bstab":6,"./inputfocus":7,"./jquery-yycountdown":8,"./loading":9,"./open":11,"./serviceworker":12,"./snses":13,"./suiranfes-updates":14,"jquery":1,"tether":2,"ua-parser-js":3}],11:[function(require,module,exports){
